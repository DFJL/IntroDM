...
Como observamos en el anterior ejercicio, el url también esta compuesto por el parámetro de *pageNumber*.Esto es debido a que por lo general cada página contiene 8 reviews.Por lo tanto, si deseamos extraer una mayor cantidad de reviews para el análisis, debemos modificar el proceso para extraer los datos en una manera iterativa:
...
# Inicializar una sesión en el sitio para realizar el scrapping responsablemente
